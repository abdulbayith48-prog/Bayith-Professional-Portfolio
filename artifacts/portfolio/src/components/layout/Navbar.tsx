    ...
    >
      <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            href="#contact"
            className="px-6 py-2 border border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-colors rounded-full text-sm font-medium uppercase tracking-wider"
          >
            Let's Talk
          </a>
        </div>
          ...
          >
            <div className="flex flex-col px-6 py-8 gap-6">
              ...
              <a
                href="#contact"
                onClick={() => setMobileMenuOpen(false)}
                className="inline-block px-6 py-3 bg-primary text-primary-foreground text-center rounded-full text-sm font-medium uppercase tracking-wider mt-4"
              >
                Let's Talk
              </a>
            </div>
